...
Code blocks are unstyled to give you full control. Code blocks however have a
`display: grid{:sass}` style by default to allow line highlighting to span the
entire width of a horizontally scrollable code block. You can disable this
